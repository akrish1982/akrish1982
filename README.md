...
### Principal AI Systems Architect | Data Architect | AWS | GenAI | Spark | Databricks

I design production AI and data platforms for regulated enterprises. My background spans 20+ years across Caylent, AWS, HSBC, and Bank of America, with a focus on LLM/RAG architecture, distributed data systems, and cloud platform modernization.

- Building GenAI platforms with Amazon Bedrock, vector search, embeddings pipelines, and agentic workflows
- Designing lakehouse and streaming architectures with Spark, Databricks, Kafka, Delta Lake, and AWS data services
- Interested in Principal/Staff-level Data and AI Architecture roles, especially in AWS-first and financial-services environments

## Selected Impact

- Architected RAG platforms over 100K+ enterprise documents using Bedrock, Pinecone, and pgvector
- Designed cloud-native lakehouse pipelines processing 5TB+ daily for banking and risk workloads
...
## Recent Public Work
- Deploy OpenClaw with Ollama, Kimi K2.5 (via OpenRouter), and Claude (via Anthropic API/subscription) on an Oracle Cloud Always-Free ARM instance, connected to Telegram. [Openclaw with Ollama in OCI](https://github.com/akrish1982/openclaw_oracle_cloud/)
...
`Python` `SQL` `PySpark` `Scala` `AWS` `Bedrock` `SageMaker` `Databricks` `Kafka` `Delta Lake` `Airflow` `PostgreSQL` `pgvector` `Pinecone` `Neo4j`
...
Marathoner and casual birding enthusiast.
